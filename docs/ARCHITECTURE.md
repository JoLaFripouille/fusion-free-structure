...
Le périmètre V1.20.1 autorise les quatre combinaisons cornière/té et conserve séparément le mode I/H vers I/H. Les mélanges entre ces deux groupes sont refusés jusqu'à leur validation explicite. Les 46 cornières et 11 tés fournis passent le contrôle géométrique automatique.
