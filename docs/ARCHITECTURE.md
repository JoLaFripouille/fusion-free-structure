...
La V1.24.0 ajoute les boulons sans rechercher de nouvelles faces. Les centres déjà validés deviennent directement les axes des fixations. Sur l'âme principale, chaque cornière reçoit sa propre colonne de boulons ; sur l'âme secondaire, un seul boulon par rangée traverse la première cornière, l'âme et la seconde cornière. L'origine locale se trouve sous la tête, avant la première rondelle, et l'axe `+Z` du composant suit l'axe du perçage. Les épaisseurs réelles des deux profils et de la cornière déterminent le serrage. La longueur sous tête comprend les deux rondelles, l'écrou et une sortie, puis est arrondie par excès au pas de `5 mm`. L'aperçu bleu et les composants finaux partagent ces mêmes placements.

Chaque fixation est un composant autonome constitué de cinq corps simples : tige cylindrique, tête hexagonale, deux rondelles annulaires et écrou hexagonal alésé. Le filetage n'est volontairement pas détaillé. La classe `8.8` est enregistrée comme désignation, mais aucun calcul de résistance ni matériau certifié de boulonnerie n'est appliqué à ce stade ; le matériau physique est provisoirement repris sur la barre secondaire. Toute erreur retire les fonctions ajoutées aux barres, les cornières et tous les boulons de la tentative.
