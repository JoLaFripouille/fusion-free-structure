...
2. Annuler complètement toute tentative créée avec une version précédente, puis arrêter et exécuter le complément et vérifier la version `V1.23.3`.
3. Ouvrir `STRUCTURE JHR > ASSEMBLAGES > Assemblage par cornières V1.23.3`.
