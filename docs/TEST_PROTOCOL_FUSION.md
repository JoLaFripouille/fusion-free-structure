...
1. Arrêter puis exécuter le complément et vérifier que les deux commandes indiquent la V1.9.1.
2. Vérifier qu'aucun message d'erreur concernant les propriétés physiques n'apparaît.
3. Ouvrir `Profil acier V1.9.1`, puis le menu `Matériau physique Fusion`.
