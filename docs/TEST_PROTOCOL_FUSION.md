...
2. Annuler complètement toute tentative créée avec la V1.23.1, puis arrêter et exécuter le complément et vérifier la version `V1.23.2`.
3. Ouvrir `STRUCTURE JHR > ASSEMBLAGES > Assemblage par cornières V1.23.2`.
