...
- commande `Grugeage profils ouverts` : double grugeage IPE/HEA/HEB ou grugeage simple pour les quatre combinaisons cornière/té, à tout angle non parallèle ; la preview rouge montre la matière retirée entre deux plans obliques parallèles, le plan orange indique la face de la branche verticale principale et le vert son éventuel prolongement.
