...
- commande `Grugeage profils ouverts` : double grugeage IPE/HEA/HEB ou grugeage simple pour les quatre combinaisons cornière/té, à tout angle non parallèle ; uniquement pour les cornières et les tés, le retrait droit suit l'épaisseur de la branche secondaire et un retrait rouge arrondi distinct échappe le congé intérieur de la principale. Le plan orange indique la face d'appui réelle et le vert son éventuel prolongement.
