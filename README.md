...
- prototype `Grugeage IPE — aperçu` : visualisation rouge dynamique d'un double grugeage sur une secondaire IPE à `90°`, sans modifier le solide tant que la méthode n'est pas validée dans Fusion.
